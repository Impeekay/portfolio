  ...
  (function (e) {
    ...
    function (e, t, r) {
      ...
      function p(e, t) {
        ...
        if (
          ...
          n < 0
            ? (e.pathname = e.path)
            : ((e.pathname = e.path.substring(0, n)), (e.search = e.path.substring(n)));
        }
      ...
      e.exports = function (e) {
        return new Promise(function (t, f) {
          ...
          if (
            ...
            var v = r(29),
              C =
                (e.withCredentials || u(g)) && e.xsrfCookieName ? v.read(e.xsrfCookieName) : void 0;
        ...
        return e
          ? (n.forEach(e.split('\n'), function (e) {
              if (
                ...
                i[t] =
                  'set-cookie' === t ? (i[t] ? i[t] : []).concat([r]) : i[t] ? i[t] + ', ' + r : r;
              }
            }),
            i)
          : i;
      ...
      e.exports = function (e) {
        return new Promise(function (t, r) {
          var v = function (e) {
            ...
            b = e.headers;
          if (
            (b['User-Agent'] || b['user-agent'] || (b['User-Agent'] = 'axios/' + d.version),
            y && !n.isStream(y))
          ) {
                ...
                q = !N.split(',')
                  ...
                  .some(function (e) {
                    return (
                      !!e &&
                      ('*' === e ||
                        ('.' === e[0] && R.hostname.substr(R.hostname.length - e.length) === e) ||
                        R.hostname === e)
                    );
                  });
    ...
    function (e, t, r) {
      ...
      function a(e) {
        return (function (e) {
          ...
          (function (e) {
            ...
            if ('CI' in s)
              return ['TRAVIS', 'CIRCLECI', 'APPVEYOR', 'GITLAB_CI'].some(e => e in s) ||
                'codeship' === s.CI_NAME
                ? 1
                : t;
      ...
      o('no-color') || o('no-colors') || o('color=false')
        ? (i = !1)
        : (o('color') || o('colors') || o('color=true') || o('color=always')) && (i = !0),
